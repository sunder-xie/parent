...
<html style="width: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body onkeydown="entersearch()" style="width: 100%; background-color: rgb(255, 255, 255);">
		...
		<div class="header">
			...
			<div class="headerCenter rel clear">
				...
				<p class="fl">
					<input type="button" value="搜索" class="headerBtn fr" onclick="findProduct();">
	...
	<%--<script src="/images/z_stat.php" language="JavaScript"></script>--%>
		...
		<!--头部固定搜索框-->
		<div class="index2Search" style="display: none;">
			<div class="index2SearchDiv rel">
				<a href="javascript:void(0);"><img src="/images/logoPecoo.png" class="fl header_logo" style="width:128px;height:26px;"></a>
				<p>
					...
					</p><ul class="searchUl abs" id="matchingUlFix">
