...
<div class="body-box">
        <div class="welcom-con">
        	 <div class="we-txt">
             	  <p>
                  欢迎使用E拍网的管理系统！<br />
                  E拍网的程序版本： Epaiv1.0 【<a href="http://localhost:8080" target="_blank">查看最新版本</a>】<br />
                  您上次登录的时间是：2017-6-05 <br />
                 ...
                 <div class="attribute-xx" style="float:left">
                 	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td height="30"><span class="black">window 10</span></td>
                        </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td height="30">admin/control<span class="black"></span></td>
                        </tr><tr>
                            <td width="30%" height="30" align="right">JAVA运行环境：</td>
                            <td height="30">JAVA_HOME:C:\Program Files\Java\jdk1.8.0_121<span></span></td>
                          </tr>
                          <tr>
                            <td width="30%" height="30" align="right">JAVA虚拟机：</td>
                            <td height="30">64bit<span></span></td>
                        </tr>
                   </table>  
               </div>
